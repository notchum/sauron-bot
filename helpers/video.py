...
class VideoProcessor:
    ...
    def __detect_blur_fft(
        self, image: cv2.Mat, size: int = 60, thresh: int = 10
    ) -> bool:
    ...
    def __detect_shot_transition(
        self, frame1: cv2.Mat, frame2: cv2.Mat, threshold: float = 0.1
    ) -> bool:
